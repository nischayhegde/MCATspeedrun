...
//   * fresh application MCQs come after, nudged up by how long since the leaf
//     was last practiced so application rotates across subtopics over sessions.
        ...
        match c.kind {
            ...
            SelKind::Mcq => {
                ...
                cands.push(Cand {
                    ...
                    kind: SelKind::Mcq,
                    leaf_id: c.leaf_id.clone(),
                    due: APPLICATION_BASE + recency + stale_boost,
                    is_new: false,
                });
            }
        }
